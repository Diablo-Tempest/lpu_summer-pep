...
app
    .get('/', async (req, res) => {
        ...
        res.json(users);
    }) // fetch all the document from the database
    ...
    }) // create ans sgtore the data on the database
    ...
    }) // update a document by targeting it's ID
    ...
    }) // delete the targeted document using ID
